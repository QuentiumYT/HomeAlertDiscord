...
#  Apr 07, 2020 12:43:33 PM CEST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top43 {base} {
    ...
    ttk::button $top.tBu44 \
        -takefocus {} -text X 
    vTcl:DefineAlias "$top.tBu44" "TButton2" vTcl:WidgetProc "Toplevel1" 1
    ttk::style configure TButton -background $vTcl(actual_gui_bg)
    ttk::style configure TButton -foreground $vTcl(actual_gui_fg)
    ttk::style configure TButton -font "$vTcl(actual_gui_font_dft_desc)"
    ttk::button $top.tBu45 \
        -takefocus {} -text I 
    vTcl:DefineAlias "$top.tBu45" "TButton2_1" vTcl:WidgetProc "Toplevel1" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.tBu49 \
