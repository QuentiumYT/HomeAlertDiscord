...
#  Mar 24, 2020 01:08:06 PM CET  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top46 {base} {
    ...
    ttk::scale $top.tSc65 \
        -to 100 -value 25 -length 100 -takefocus {} 
    ...
    place $top.tEn66 \
        -in $top -x 0 -relx 0.333 -y 0 -rely 0.656 -width 0 -relwidth 0.333 \
    ...
    place $top.tBu69 \
        -in $top -x 0 -relx 0.208 -y 0 -rely 0.656 -width 40 -relwidth 0 \
        -height 40 -relheight 0 -anchor nw -bordermode ignore 
    place $top.tBu70 \
        -in $top -x 0 -relx 0.708 -y 0 -rely 0.656 -width 40 -relwidth 0 \
        -height 40 -relheight 0 -anchor nw -bordermode ignore 
